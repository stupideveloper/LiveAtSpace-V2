	...
	return(
		...
		<Head>
			...
			<div className={styles.container}>
				<h1>About.</h1>
				<div>
					<p style={{lineHeight:"1.45rem"}}><bold>Live@Space</bold> was and is developed to serve as a hub for all rocket future launches and other space activity. It all launches from SpaceX, NASA, Rocket Lab and all other areospace companies and organizations. </p>
